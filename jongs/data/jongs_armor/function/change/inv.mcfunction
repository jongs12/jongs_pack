...
execute as @s[nbt={Inventory:[{Slot:102b,components:{"minecraft:custom_data":{jongs: {part:chestplate} }}},{Slot:-106b}]}] run function jongs_armor:change/chestplate
execute as @s[nbt=!{Inventory:[{Slot:102b,components:{"minecraft:custom_data":{jongs: {part:chestplate} }}}]},nbt={Inventory:[{Slot:-106b}]}] run function jongs_armor:change/armor/check
#
###menu를 home으로.###
