...
###hot2를 1에서 2로.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot2,order:1} }}}]}] run data modify entity @n[tag=jongs_armor] ArmorItems[2].components."minecraft:custom_data".jongs.hot2 set value 2
#
###hot3을 0으로.###
...
###hot3일 때 날씨 변경.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot3,order:0} }}}]}] run weather thunder
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot3,order:1} }}}]}] run weather clear
#
###hot4를 0으로.###
...
###hot4를 1에서 2로.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot4,order:1} }}}]}] run data modify entity @n[tag=jongs_armor] ArmorItems[2].components."minecraft:custom_data".jongs.hot4 set value 2
#
###hot5를 0으로.###
...
###hot5를 1에서 2로.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot5,order:1} }}}]}] run data modify entity @n[tag=jongs_armor] ArmorItems[2].components."minecraft:custom_data".jongs.hot5 set value 2
#
###hot6을 0으로.###
...
###hot6을 1에서 2로.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot6,order:1} }}}]}] run data modify entity @n[tag=jongs_armor] ArmorItems[2].components."minecraft:custom_data".jongs.hot6 set value 2
#
###hot7을 0으로.###
...
###hot7을 1에서 2로.###
execute as @s[nbt={Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{jongs: {slot:hot7,order:1} }}}]}] run data modify entity @n[tag=jongs_armor] ArmorItems[2].components."minecraft:custom_data".jongs.hot7 set value 2
#
###time을 day에서 night로.###
