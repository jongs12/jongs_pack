...
#
###부츠 마법부여.###
data modify entity @n[tag=jongs_armor] ArmorItems[0].components."minecraft:enchantments".levels set value {'minecraft:thorns':10,'jongs_armor:liquid_remover':1,'minecraft:soul_speed':2,'minecraft:binding_curse':1,'minecraft:vanishing_curse':1}
#
###helmet type.###
