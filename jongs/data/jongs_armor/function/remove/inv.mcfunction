...
#
###지속시간이 무한대인 포화 10이 있으면 제거합니다.###
execute as @s[nbt={active_effects:[{id:"minecraft:saturation",duration:-1,amplifier:9b,show_particles:0b}]}] run effect clear @s minecraft:saturation
#
