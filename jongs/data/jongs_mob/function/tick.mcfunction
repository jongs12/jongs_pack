...
execute if score core jongs_tick_7 matches 1 as @a run function jongs_armor:change/check
execute if score core jongs_tick_7 matches 5 as @a run function jongs_armor:change/check
#
###핫바의 아이템이 맞는 슬롯에 들어가 있는지 확인하고 지급합니다.###
execute if score core jongs_tick_7 matches 3 as @a run function jongs_armor:give/hot_check
execute if score core jongs_tick_7 matches 7 as @a run function jongs_armor:give/hot_check
#
###메뉴가 home일 때 아이템이 맞는 슬롯에 들어가 있는지 확인하고 지급합니다.###
execute if score core jongs_tick_7 matches 2 as @a run function jongs_armor:give/home_check
#
###갑옷을 입고 있는지 확인하고 효과를 발동합니다.###
execute if score core jongs_tick_7 matches 4 as @a run function jongs_armor:aura/check
#
...
#
###측정한 데미지를 알려줍니다.###
execute as @a[tag=jongs_damage] if score core jongs_tick_7 matches 7 run function jongs_mob:damage/check